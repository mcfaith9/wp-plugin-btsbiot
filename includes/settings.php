...
function network_admin_menu() {
	...
	add_submenu_page(
		'distributor-settings', // Parent element
		'Sync User Options', // Text in browser title bar
		'Sync User Options', // Text to be displayed in the menu.
	...
	add_submenu_page(
		'distributor-settings', // Parent element
		'Sync User Actions', // Text in browser title bar
		'Sync User Actions', // Text to be displayed in the menu.
		'manage_options', // Capability
